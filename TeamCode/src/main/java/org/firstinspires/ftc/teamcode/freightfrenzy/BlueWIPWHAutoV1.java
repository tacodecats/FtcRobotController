...
@Autonomous(name = "BlueWIPWHAutoV1")
public class BlueWIPWHAutoV1 extends LinearOpMode {
    OpenCvCamera webcam;
    String level;
    ...
    public void runAuto(){
        ...
        turnDrive(0.4,-18,18);
        strafeLeft(0.4,23,23,0);
        armMotor.setTargetPosition(0);
        armMotor.setPower(0.5);
        armMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        boxServo.setPosition(0);
        intakeMotor.setPower(1);
        forwardDrive(0.3,56,56,  90);
        ...
        forwardDrive(0.3,10,10,90);
        backwardDrive(0.6,66,66,90);
        strafeRight(0.4,3,3,90);
        turnDrive(0.4,18,-18);
        forwardDrive(0.4,22,22,90);
        ...
        backwardDrive(0.4,-23,-23,0);
        strafeLeft(0.3,56,56,-90);
        forwardDrive(0.4,15,15,90);
