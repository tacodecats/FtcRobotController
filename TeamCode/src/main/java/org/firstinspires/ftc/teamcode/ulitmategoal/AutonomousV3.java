...
public class AutonomousV3 extends LinearOpMode {
    ...
    public void dropWobbleGoal() {
        wobbleArmMotor.setTargetPosition(400);
    ...
    public void targetZoneA(){
        ...
        strafeRight(.5,11,11, 0);
        //Move robot to shooter zone
        forwardDrive(.4,9,8, 0);
        //Shoot three rings
        shootingThreeRings();
        //Power off shooter
        powerOffShooter();
        //Strafe robot to the right
        strafeRight(.5,32,32, 0);
    ...
    public void targetZoneB(){
        ...
        backwardDrive(.65, 91,91, 0);
        //Strafe right into box B
        strafeRight(.5,27,27, 0);
        //Place wobble goal in square
        dropWobbleGoal();
        //Retract wobble goal arm
        retractWobbleGoalArm();
        ...
        forwardDrive(.5,29,29, 0);
        //Strafe left to shooter zone
        strafeLeft(.75,12,12, 0);
        //Shoot three rings
        shootingThreeRings();
        //Power on intake
        intakeOn();
        ...
        powerOffShooter();
        //Strafe robot to the right
        strafeRight(.65,31,31, 0);
        //Move forward to second wobble goal
        forwardDrive(.65,55,55,0);
        //Open wobble goal arm
        openWobbleGoalArm();
        backwardDrive(.5,3,3,0);
        //Pick up the second wobble goal
    ...
    public void targetZoneC(){
        ...
        //Move robot to shooter zone
        forwardDrive(.4,56.5,56, 0);
        //Shoot three rings
        shootingThreeRings();
        //Power shooter off
        powerOffShooter();
        //Strafe robot to the right
        strafeRight(.5,29,29, 0);
        //Move forward to second wobble goal
        forwardDrive(.5,56,56,0);
        //Open wobble goal arm
        openWobbleGoalArm();
        backwardDrive(.5,3,3,0);
        //Pick up the second wobble goal
