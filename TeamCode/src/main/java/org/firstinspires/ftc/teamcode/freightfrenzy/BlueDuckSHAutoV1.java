...
@Autonomous(name = "BlueDuckSHAutoV1")
public class BlueDuckSHAutoV1 extends LinearOpMode {
    OpenCvCamera webcam;
    String level;
    ...
    public void runAuto(){
       ...
       forwardDrive(0.5,4,4,0);
       turnDrive(0.4,20,-20);
        forwardDrive(0.3,29,29,-20);
        turnDrive(0.3,9,-9 );
        ...
        strafeLeft(0.5,13,13,-90);
        turnDrive(0.3,-18,18);
        forwardDrive(0.4,28,28,0);
        turnDrive(0.5,-18.5,18.5);
        ...
        backwardDrive(0.3,3,3,0);
        bottomLvl();
        backwardDrive(0.4,42,42,-25);
        strafeLeft(0.5,6,6,0);
