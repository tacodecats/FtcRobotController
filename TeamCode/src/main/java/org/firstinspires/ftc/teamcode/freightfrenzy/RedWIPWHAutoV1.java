...
@Autonomous(name = "RedWIPWHAutoV1")
public class RedWIPWHAutoV1 extends LinearOpMode {
    OpenCvCamera webcam;
    String level;
    ...
    public void turnDrive(double speed, double leftInches, double rightInches){
        // this creates the variables that will be calculated
        int newLeftFrontTarget = 0;
        int newRightFrontTarget = 0;
        int newLeftBackTarget = 0;
    ...
    public void runAuto(){
        ...
        forwardDrive(0.7,18,18 ,0);


        if(level == "lower" || level == "middle") {
            lowMidRelease();
            sleep(500);
        ...
        turnDrive(0.6,18,-18);
        strafeRight(0.7,23,23,0);
        armMotor.setTargetPosition(0);
        armMotor.setPower(0.5);
        armMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        boxServo.setPosition(0);
        intakeMotor.setPower(1);
        forwardDrive(0.5,56,56,  -90);
        ...
        forwardDrive(0.5,13,13,-90);
        backwardDrive(0.8,66,66,-90);
        strafeLeft(0.6,3,3,-90);
        turnDrive(0.6,-18,18);
        forwardDrive(0.7,22,22,-90);
        ...
        backwardDrive(0.6,26,26,0);
        forwardDrive(0.7,4,4,-90);
        turnDrive(0.6,18,-18);
        strafeRight(0.6,5,5,-90);
        forwardDrive(0.6,56,56,-90);
        strafeLeft(0.6,24,24,-90);
