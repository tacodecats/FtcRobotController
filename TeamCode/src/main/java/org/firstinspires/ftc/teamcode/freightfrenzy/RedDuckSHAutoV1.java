...
@Autonomous(name = "RedDuckSHAutoV1")
public class RedDuckSHAutoV1 extends LinearOpMode {
    OpenCvCamera webcam;
    String level;
    ...
    public void runAuto(){
       ...
       turnDrive(0.4,-17,17);
        forwardDrive(0.3,16,16,90);

        duckMotor.setPower(-0.6);
        sleep(5000);
        duckMotor.setPower(0);

        strafeRight(0.5,40,40,-90);
        turnDrive(0.5,-32,32);
        ...
        backwardDrive(0.4,36,36,-45);
        strafeRight(0.5,5,5 ,0);
