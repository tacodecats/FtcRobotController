...
@Autonomous(name = "RedDuckWHAutoV1")
public class RedDuckWHAutoV1 extends LinearOpMode {
    OpenCvCamera webcam;
    String level;
    ...
    public void runAuto(){
        ...
        forwardDrive(0.3,3,3,0);
        strafeRight(0.4,3,3,0);
        forwardDrive(0.3,11,11,0);

        duckMotor.setPower(-0.6);
        sleep(4000);
        duckMotor.setPower(0);

        backwardDrive(0.8,90,90,0);
        strafeRight(0.4,29,29,0);
